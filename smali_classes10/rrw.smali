...
.method public constructor <init>(Lokhttp3/OkHttpClient;Z)V
    ...
    .line 2
    iput-object p1, p0, Lrrw;->a:Lokhttp3/OkHttpClient;
...
.method public a()V
    ...
    .line 1
    iput-boolean v0, p0, Lrrw;->d:Z

    .line 2
    iget-object v0, p0, Lrrw;->b:Lhrw;
...
.method public final b(Lokhttp3/HttpUrl;)Lokhttp3/Address;
    ...
    .line 2
    iget-object v1, v0, Lrrw;->a:Lokhttp3/OkHttpClient;
    ...
    .line 4
    iget-object v3, v0, Lrrw;->a:Lokhttp3/OkHttpClient;
    ...
    iget-object v2, v0, Lrrw;->a:Lokhttp3/OkHttpClient;
...
.method public final c(Lokhttp3/Response;Lokhttp3/Route;)Lokhttp3/Request;
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lrrw;->a:Lokhttp3/OkHttpClient;
    ...
    .line 7
    invoke-virtual {p0, p1, p2}, Lrrw;->g(Lokhttp3/Response;I)I
    ...
    :cond_c
    :pswitch_0
    iget-object p2, p0, Lrrw;->a:Lokhttp3/OkHttpClient;
    ...
    .line 26
    invoke-static {v1}, Lnrw;->b(Ljava/lang/String;)Z
    ...
    .line 27
    invoke-static {v1}, Lnrw;->d(Ljava/lang/String;)Z
    ...
    .line 35
    :cond_13
    invoke-virtual {p0, p1, p2}, Lrrw;->h(Lokhttp3/Response;Lokhttp3/HttpUrl;)Z
...
.method public final f(Ljava/io/IOException;Lhrw;ZLokhttp3/Request;)Z
    .locals 2

    .line 1
    invoke-virtual {p2, p1}, Lhrw;->q(Ljava/io/IOException;)V
    ...
    .line 4
    :cond_1
    invoke-virtual {p0, p1, p3}, Lrrw;->e(Ljava/io/IOException;Z)Z
...
.method public final h(Lokhttp3/Response;Lokhttp3/HttpUrl;)Z
    .locals 2
...
.method public i(Ljava/lang/Object;)V
    ...
    .line 1
    iput-object p1, p0, Lrrw;->c:Ljava/lang/Object;
...
.method public intercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    .line 3
    invoke-virtual {p1}, Lorw;->call()Lokhttp3/Call;
    ...
    iget-object v1, p0, Lrrw;->a:Lokhttp3/OkHttpClient;
    ...
    invoke-virtual {p0, v1}, Lrrw;->b(Lokhttp3/HttpUrl;)Lokhttp3/Address;

    move-result-object v3

    iget-object v6, p0, Lrrw;->c:Ljava/lang/Object;
    ...
    invoke-direct/range {v1 .. v6}, Lhrw;-><init>(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lokhttp3/Call;Lokhttp3/EventListener;Ljava/lang/Object;)V

    .line 7
    iput-object v9, p0, Lrrw;->b:Lhrw;
    ...
    .line 8
    :goto_0
    iget-boolean v3, p0, Lrrw;->d:Z

    if-nez v3, :cond_8

    .line 9
    :try_start_0
    invoke-virtual {p1, v0, v9, v11, v11}, Lorw;->c(Lokhttp3/Request;Lhrw;Lkrw;Lokhttp3/internal/connection/RealConnection;)Lokhttp3/Response;

    move-result-object v0
    :try_end_0
    .catch Lfrw; {:try_start_0 .. :try_end_0} :catch_2
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v9}, Lhrw;->o()Lokhttp3/Route;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lrrw;->c(Lokhttp3/Response;Lokhttp3/Route;)Lokhttp3/Request;
    ...
    invoke-virtual {p0, v0, v1}, Lrrw;->h(Lokhttp3/Response;Lokhttp3/HttpUrl;)Z
    ...
    .line 32
    :goto_2
    invoke-virtual {p0, v3, v9, v4, v0}, Lrrw;->f(Ljava/io/IOException;Lhrw;ZLokhttp3/Request;)Z
    ...
    .line 33
    invoke-virtual {v3}, Lfrw;->c()Ljava/io/IOException;

    move-result-object v4

    invoke-virtual {p0, v4, v9, v10, v0}, Lrrw;->f(Ljava/io/IOException;Lhrw;ZLokhttp3/Request;)Z
    ...
    .line 34
    :cond_7
    invoke-virtual {v3}, Lfrw;->b()Ljava/io/IOException;
    ...
    .line 35
    :goto_3
    invoke-virtual {v9, v11}, Lhrw;->q(Ljava/io/IOException;)V
