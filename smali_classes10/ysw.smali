...
.method public constructor <init>(ZLokio/BufferedSink;Ljava/util/Random;)V
    ...
    iput-object v0, p0, Lysw;->f:Lokio/Buffer;

    .line 3
    new-instance v0, Lysw$a;

    invoke-direct {v0, p0}, Lysw$a;-><init>(Lysw;)V

    iput-object v0, p0, Lysw;->g:Lysw$a;
    ...
    .line 6
    iput-boolean p1, p0, Lysw;->a:Z

    .line 7
    iput-object p2, p0, Lysw;->c:Lokio/BufferedSink;
    ...
    iput-object p2, p0, Lysw;->d:Lokio/Buffer;

    .line 9
    iput-object p3, p0, Lysw;->b:Ljava/util/Random;
    ...
    :cond_1
    iput-object p2, p0, Lysw;->j:Lokio/Buffer$UnsafeCursor;
...
.method public a(IJ)Lokio/Sink;
    ...
    .line 2
    iput-boolean v0, p0, Lysw;->h:Z

    .line 3
    iget-object v1, p0, Lysw;->g:Lysw$a;

    iput p1, v1, Lysw$a;->B:I

    .line 4
    iput-wide p2, v1, Lysw$a;->I:J

    .line 5
    iput-boolean v0, v1, Lysw$a;->S:Z

    const/4 p1, 0x0

    .line 6
    iput-boolean p1, v1, Lysw$a;->T:Z
...
.method public b(ILokio/ByteString;)V
    ...
    .line 7
    :try_start_0
    invoke-virtual {p0, p1, v0}, Lysw;->c(ILokio/ByteString;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 8
    iput-boolean p2, p0, Lysw;->e:Z
...
.method public final c(ILokio/ByteString;)V
    ...
    .line 3
    iget-object v1, p0, Lysw;->d:Lokio/Buffer;

    invoke-virtual {v1, p1}, Lokio/Buffer;->writeByte(I)Lokio/Buffer;

    .line 4
    iget-boolean p1, p0, Lysw;->a:Z
    ...
    .line 6
    iget-object p1, p0, Lysw;->b:Ljava/util/Random;

    iget-object v1, p0, Lysw;->i:[B

    invoke-virtual {p1, v1}, Ljava/util/Random;->nextBytes([B)V

    .line 7
    iget-object p1, p0, Lysw;->d:Lokio/Buffer;
    ...
    iget-object p2, p0, Lysw;->i:[B

    invoke-static {p1, p2}, Lwsw;->b(Lokio/Buffer$UnsafeCursor;[B)V
    ...
    :cond_1
    :goto_0
    iget-object p1, p0, Lysw;->c:Lokio/BufferedSink;
...
.method public d(IJZZ)V
    ...
    .line 2
    :cond_1
    iget-object p4, p0, Lysw;->d:Lokio/Buffer;
    ...
    iget-object v0, p0, Lysw;->f:Lokio/Buffer;
    ...
    iget-object p4, p0, Lysw;->f:Lokio/Buffer;
...
.method public e(Lokio/ByteString;)V
    ...
    .line 1
    invoke-virtual {p0, v0, p1}, Lysw;->c(ILokio/ByteString;)V
