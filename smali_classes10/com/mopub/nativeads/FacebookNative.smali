...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/mopub/nativeads/FacebookNative$b;
    }
.end annotation
...
.method public getServerExtras()Ljava/util/Map;
    ...
    .line 1
    iget-object v0, p0, Lcom/mopub/nativeads/FacebookNative;->a:Ljava/util/Map;
...
.method public loadNativeAd(Landroid/content/Context;Lcom/mopub/nativeads/MoPubAdRenderer;Lcom/mopub/nativeads/CustomEventNative$CustomEventNativeListener;Ljava/util/Map;Ljava/util/Map;)V
    ...
    new-instance v8, Lcom/mopub/nativeads/FacebookNative$a;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/mopub/nativeads/FacebookNative$a;-><init>(Lcom/mopub/nativeads/FacebookNative;Landroid/content/Context;Lcom/mopub/nativeads/MoPubAdRenderer;Lcom/mopub/nativeads/CustomEventNative$CustomEventNativeListener;Ljava/util/Map;Ljava/util/Map;)V
    ...
    .line 4
    :cond_0
    iput-object p5, p0, Lcom/mopub/nativeads/FacebookNative;->a:Ljava/util/Map;

    .line 5
    invoke-virtual {p0, p5}, Lcom/mopub/nativeads/FacebookNative;->a(Ljava/util/Map;)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, p4}, Lcom/mopub/nativeads/FacebookNative;->b(Ljava/util/Map;)Z
    ...
    .line 13
    :cond_1
    new-instance v0, Lcom/mopub/nativeads/FacebookNative$b;

    new-instance v6, Lcom/facebook/ads/NativeAd;

    invoke-direct {v6, p1, v8}, Lcom/facebook/ads/NativeAd;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct/range {v1 .. v8}, Lcom/mopub/nativeads/FacebookNative$b;-><init>(Landroid/content/Context;Lcom/mopub/nativeads/MoPubAdRenderer;Ljava/util/Map;Ljava/util/Map;Lcom/facebook/ads/NativeAd;Lcom/mopub/nativeads/CustomEventNative$CustomEventNativeListener;Ljava/lang/String;)V

    .line 14
    invoke-virtual {v0}, Lcom/mopub/nativeads/FacebookNative$b;->loadAd()V
...
.method public setServerExtras(Ljava/util/Map;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/mopub/nativeads/FacebookNative;->a:Ljava/util/Map;
