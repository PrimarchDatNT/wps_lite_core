...
.field public S:Lcom/mopub/common/privacy/ConsentDialogListener;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/mopub/common/privacy/ConsentDialogController;->V:Landroid/os/Handler;
...
.method public a()Z
    ...
    .line 1
    iget-boolean v0, p0, Lcom/mopub/common/privacy/ConsentDialogController;->T:Z

    return v0
.end method

.method public declared-synchronized b(Lcom/mopub/common/privacy/ConsentDialogListener;Ljava/lang/Boolean;Lpyv;)V
    .locals 5
    ...
    .line 3
    iget-object p2, p0, Lcom/mopub/common/privacy/ConsentDialogController;->V:Landroid/os/Handler;
    ...
    :cond_1
    :try_start_1
    iget-boolean v0, p0, Lcom/mopub/common/privacy/ConsentDialogController;->U:Z
    ...
    :cond_2
    :try_start_2
    iput-object p1, p0, Lcom/mopub/common/privacy/ConsentDialogController;->S:Lcom/mopub/common/privacy/ConsentDialogListener;

    .line 9
    iput-boolean v1, p0, Lcom/mopub/common/privacy/ConsentDialogController;->U:Z
    ...
    .line 11
    invoke-virtual {p3}, Lpyv;->b()Ljava/lang/String;

    move-result-object v3

    .line 12
    invoke-virtual {p3}, Lpyv;->e()Lcom/mopub/common/privacy/ConsentStatus;
    ...
    .line 13
    invoke-virtual {v1, p2}, Lcom/mopub/common/privacy/ConsentDialogUrlGenerator;->q(Ljava/lang/Boolean;)Lcom/mopub/common/privacy/ConsentDialogUrlGenerator;

    .line 14
    invoke-virtual {p3}, Lpyv;->getConsentedPrivacyPolicyVersion()Ljava/lang/String;
    ...
    .line 15
    invoke-virtual {p3}, Lpyv;->getConsentedVendorListVersion()Ljava/lang/String;

    move-result-object p2

    invoke-virtual {v1, p2}, Lcom/mopub/common/privacy/ConsentDialogUrlGenerator;->o(Ljava/lang/String;)Lcom/mopub/common/privacy/ConsentDialogUrlGenerator;

    .line 16
    invoke-virtual {p3}, Lpyv;->isForceGdprApplies()Z

    move-result p2

    invoke-virtual {v1, p2}, Lcom/mopub/common/privacy/ConsentDialogUrlGenerator;->p(Z)Lcom/mopub/common/privacy/ConsentDialogUrlGenerator;
...
.method public final c()V
    ...
    .line 1
    iput-boolean v0, p0, Lcom/mopub/common/privacy/ConsentDialogController;->U:Z

    .line 2
    iput-boolean v0, p0, Lcom/mopub/common/privacy/ConsentDialogController;->T:Z

    const/4 v0, 0x0

    .line 3
    iput-object v0, p0, Lcom/mopub/common/privacy/ConsentDialogController;->S:Lcom/mopub/common/privacy/ConsentDialogListener;

    .line 4
    iput-object v0, p0, Lcom/mopub/common/privacy/ConsentDialogController;->I:Ljava/lang/String;
...
.method public d()Z
    ...
    iget-object v0, p0, Lcom/mopub/common/privacy/ConsentDialogController;->I:Ljava/lang/String;
    ...
    .line 3
    :cond_0
    iput-boolean v1, p0, Lcom/mopub/common/privacy/ConsentDialogController;->T:Z

    .line 4
    iget-object v0, p0, Lcom/mopub/common/privacy/ConsentDialogController;->B:Landroid/content/Context;

    iget-object v1, p0, Lcom/mopub/common/privacy/ConsentDialogController;->I:Ljava/lang/String;
...
.method public onErrorResponse(Lcom/mopub/volley/VolleyError;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/mopub/common/privacy/ConsentDialogController;->S:Lcom/mopub/common/privacy/ConsentDialogListener;
...
.method public onSuccess(Loyv;)V
    .locals 5
    ...
    .line 2
    invoke-virtual {p1}, Loyv;->getHtml()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lcom/mopub/common/privacy/ConsentDialogController;->I:Ljava/lang/String;
    ...
    .line 5
    iget-object p1, p0, Lcom/mopub/common/privacy/ConsentDialogController;->S:Lcom/mopub/common/privacy/ConsentDialogListener;
