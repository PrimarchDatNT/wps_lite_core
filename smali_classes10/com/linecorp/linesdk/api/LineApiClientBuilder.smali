...
.method public apiBaseUri(Landroid/net/Uri;)Lcom/linecorp/linesdk/api/LineApiClientBuilder;
    ...
    .line 2
    invoke-static {p1, v0}, Le8v;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public build()Lg6v;
    ...
    invoke-direct {v2, v3, v4, v5}, Lp7v;-><init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;)V

    new-instance v3, Lt7v;

    iget-object v4, p0, Lcom/linecorp/linesdk/api/LineApiClientBuilder;->context:Landroid/content/Context;

    iget-object v5, p0, Lcom/linecorp/linesdk/api/LineApiClientBuilder;->apiBaseUri:Landroid/net/Uri;

    invoke-direct {v3, v4, v5}, Lt7v;-><init>(Landroid/content/Context;Landroid/net/Uri;)V

    new-instance v4, La7v;
    ...
    invoke-direct {v4, v5, v6}, La7v;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    invoke-direct {v0, v1, v2, v3, v4}, Ls6v;-><init>(Ljava/lang/String;Lp7v;Lt7v;La7v;)V
    ...
    .line 5
    :cond_1
    invoke-static {v0}, Lr6v;->a(Lg6v;)Lg6v;
