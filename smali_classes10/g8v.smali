...
.method public static b(Landroid/net/Uri;Ljava/util/Map;)Landroid/net/Uri;
    ...
    .line 1
    invoke-static {p0, v0}, Lg8v;->f(Landroid/net/Uri;[Ljava/lang/String;)Landroid/net/Uri$Builder;

    move-result-object p0

    invoke-static {p0, p1}, Lg8v;->a(Landroid/net/Uri$Builder;Ljava/util/Map;)Landroid/net/Uri$Builder;
...
.method public static c(Ljava/lang/String;Ljava/util/Map;)Landroid/net/Uri;
    ...
    invoke-static {p0, p1}, Lg8v;->b(Landroid/net/Uri;Ljava/util/Map;)Landroid/net/Uri;
...
.method public static varargs e(Landroid/net/Uri;[Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 1
    invoke-static {p0, p1}, Lg8v;->f(Landroid/net/Uri;[Ljava/lang/String;)Landroid/net/Uri$Builder;
