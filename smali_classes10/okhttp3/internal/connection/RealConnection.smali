...
.field private http2Connection:Lasw;
...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-virtual {p2, p3, p4, p1}, Losw;->i(Ljava/net/Socket;Ljava/net/InetSocketAddress;I)V
    :try_end_0
...
.method private connectTls(Ldrw;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 6
    :try_start_1
    invoke-virtual {p1, v1}, Ldrw;->a(Ljavax/net/ssl/SSLSocket;)Lokhttp3/ConnectionSpec;
    ...
    .line 10
    invoke-virtual {v3, v1, v4, v5}, Losw;->h(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {p1, v1}, Losw;->n(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v1}, Losw;->a(Ljavax/net/ssl/SSLSocket;)V
    ...
    .line 31
    invoke-static {p1}, Ltsw;->a(Ljava/security/cert/X509Certificate;)Ljava/util/List;
    ...
    :goto_1
    :try_start_3
    invoke-static {p1}, Luqw;->A(Ljava/lang/AssertionError;)Z
    ...
    invoke-virtual {v0, v2}, Losw;->a(Ljavax/net/ssl/SSLSocket;)V
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-static {p4, v1}, Luqw;->s(Lokhttp3/HttpUrl;Z)Ljava/lang/String;
    ...
    invoke-direct {v0, v3, v3, v1, v2}, Ltrw;-><init>(Lokhttp3/OkHttpClient;Lhrw;Lokio/BufferedSource;Lokio/BufferedSink;)V
    ...
    invoke-virtual {v0, v1, p4}, Ltrw;->o(Lokhttp3/Headers;Ljava/lang/String;)V

    .line 6
    invoke-virtual {v0}, Ltrw;->c()V

    const/4 v1, 0x0

    .line 7
    invoke-virtual {v0, v1}, Ltrw;->f(Z)Lokhttp3/Response$Builder;
    ...
    .line 10
    invoke-static {p3}, Lmrw;->b(Lokhttp3/Response;)J
    ...
    .line 11
    :cond_0
    invoke-virtual {v0, v4, v5}, Ltrw;->k(J)Lokio/Source;
    ...
    .line 12
    invoke-static {v0, v1, v2}, Luqw;->D(Lokio/Source;ILjava/util/concurrent/TimeUnit;)Z
...
.method private createTunnelRequest()Lokhttp3/Request;
    ...
    invoke-static {v1, v2}, Luqw;->s(Lokhttp3/HttpUrl;Z)Ljava/lang/String;
    ...
    .line 6
    invoke-static {}, Lvqw;->a()Ljava/lang/String;
    ...
    sget-object v2, Luqw;->c:Lokhttp3/ResponseBody;
...
.method private establishProtocol(Ldrw;ILokhttp3/Call;Lokhttp3/EventListener;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 9
    invoke-direct {p0, p1}, Lokhttp3/internal/connection/RealConnection;->connectTls(Ldrw;)V
...
.method private startHttp2(I)V
    ...
    invoke-direct {v0, v1}, Lasw$g;-><init>(Z)V
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lasw$g;->d(Ljava/net/Socket;Ljava/lang/String;Lokio/BufferedSource;Lokio/BufferedSink;)Lasw$g;

    .line 4
    invoke-virtual {v0, p0}, Lasw$g;->b(Lasw$h;)Lasw$g;

    .line 5
    invoke-virtual {v0, p1}, Lasw$g;->c(I)Lasw$g;

    .line 6
    invoke-virtual {v0}, Lasw$g;->a()Lasw;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->http2Connection:Lasw;

    .line 7
    invoke-virtual {p1}, Lasw;->y()V
...
.method public cancel()V
    ...
    invoke-static {v0}, Luqw;->h(Ljava/net/Socket;)V
...
.method public connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 3
    new-instance v10, Ldrw;

    invoke-direct {v10, v0}, Ldrw;-><init>(Ljava/util/List;)V
    ...
    invoke-virtual {v1, v0}, Losw;->p(Ljava/lang/String;)Z
    ...
    invoke-direct {v1, v2}, Lfrw;-><init>(Ljava/io/IOException;)V
    ...
    invoke-direct {v0, v1}, Lfrw;-><init>(Ljava/io/IOException;)V
    ...
    .line 15
    :try_start_2
    invoke-direct {v7, v10, v15, v8, v9}, Lokhttp3/internal/connection/RealConnection;->establishProtocol(Ldrw;ILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-direct {v1, v0}, Lfrw;-><init>(Ljava/io/IOException;)V
    ...
    :cond_6
    :goto_4
    iget-object v0, v7, Lokhttp3/internal/connection/RealConnection;->http2Connection:Lasw;
    ...
    invoke-static {v1}, Luqw;->h(Ljava/net/Socket;)V
    ...
    .line 32
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->http2Connection:Lasw;
    ...
    .line 34
    new-instance v12, Lfrw;

    invoke-direct {v12, v0}, Lfrw;-><init>(Ljava/io/IOException;)V

    goto :goto_8

    .line 35
    :cond_8
    invoke-virtual {v12, v0}, Lfrw;->a(Ljava/io/IOException;)V

    :goto_8
    if-eqz p5, :cond_9

    .line 36
    invoke-virtual {v10, v0}, Ldrw;->b(Ljava/io/IOException;)Z
...
.method public isEligible(Lokhttp3/Address;Lokhttp3/Route;)Z
    ...
    invoke-virtual {v0, v1, p1}, Lsqw;->equalsNonHost(Lokhttp3/Address;Lokhttp3/Address;)Z
    ...
    .line 4
    :cond_2
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->http2Connection:Lasw;
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Lhrw;)Lkrw;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->http2Connection:Lasw;

    invoke-direct {v0, p1, p2, p3, v1}, Lzrw;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Lhrw;Lasw;)V
    ...
    .line 6
    new-instance p2, Ltrw;

    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lokio/BufferedSource;

    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lokio/BufferedSink;

    invoke-direct {p2, p1, p3, v0, v1}, Ltrw;-><init>(Lokhttp3/OkHttpClient;Lhrw;Lokio/BufferedSource;Lokio/BufferedSink;)V

    return-object p2
.end method

.method public newWebSocketStreams(Lhrw;)Lvsw$g;
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/connection/RealConnection$a;-><init>(Lokhttp3/internal/connection/RealConnection;ZLokio/BufferedSource;Lokio/BufferedSink;Lhrw;)V
...
.method public supportsUrl(Lokhttp3/HttpUrl;)Z
    ...
    .line 5
    invoke-virtual {v0, p1, v3}, Ltsw;->c(Ljava/lang/String;Ljava/security/cert/X509Certificate;)Z
