...
.method public deduplicate(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lhrw;)Ljava/net/Socket;
    .locals 0

    .line 1
    invoke-virtual {p1, p2, p3}, Lokhttp3/ConnectionPool;->deduplicate(Lokhttp3/Address;Lhrw;)Ljava/net/Socket;
...
.method public get(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lhrw;Lokhttp3/Route;)Lokhttp3/internal/connection/RealConnection;
    .locals 0

    .line 1
    invoke-virtual {p1, p2, p3, p4}, Lokhttp3/ConnectionPool;->get(Lokhttp3/Address;Lhrw;Lokhttp3/Route;)Lokhttp3/internal/connection/RealConnection;
...
.method public routeDatabase(Lokhttp3/ConnectionPool;)Lerw;
    .locals 0

    .line 1
    iget-object p1, p1, Lokhttp3/ConnectionPool;->routeDatabase:Lerw;

    return-object p1
.end method

.method public setCache(Lokhttp3/OkHttpClient$Builder;Lbrw;)V
    .locals 0

    .line 1
    invoke-virtual {p1, p2}, Lokhttp3/OkHttpClient$Builder;->setInternalCache(Lbrw;)V

    return-void
.end method

.method public streamAllocation(Lokhttp3/Call;)Lhrw;
    .locals 0

    .line 1
    check-cast p1, Lokhttp3/RealCall;

    invoke-virtual {p1}, Lokhttp3/RealCall;->streamAllocation()Lhrw;
