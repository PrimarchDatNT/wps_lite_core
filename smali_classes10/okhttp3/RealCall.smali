...
.field public final retryAndFollowUpInterceptor:Lrrw;
...
.method private constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/Request;Z)V
    ...
    invoke-direct {p2, p1, p3}, Lrrw;-><init>(Lokhttp3/OkHttpClient;Z)V

    iput-object p2, p0, Lokhttp3/RealCall;->retryAndFollowUpInterceptor:Lrrw;
...
.method private captureCallStackTrace()V
    ...
    invoke-virtual {v0, v1}, Losw;->o(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    .line 2
    iget-object v1, p0, Lokhttp3/RealCall;->retryAndFollowUpInterceptor:Lrrw;

    invoke-virtual {v1, v0}, Lrrw;->i(Ljava/lang/Object;)V
...
.method public cancel()V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/RealCall;->retryAndFollowUpInterceptor:Lrrw;
...
.method public getResponseWithInterceptorChain()Lokhttp3/Response;
    ...
    invoke-direct {v0, v2}, Lirw;-><init>(Lokhttp3/CookieJar;)V
    ...
    invoke-virtual {v2}, Lokhttp3/OkHttpClient;->internalCache()Lbrw;

    move-result-object v2

    invoke-direct {v0, v2}, Lwqw;-><init>(Lbrw;)V
    ...
    invoke-direct {v0, v2}, Lcrw;-><init>(Lokhttp3/OkHttpClient;)V
    ...
    invoke-direct {v0, v2}, Ljrw;-><init>(Z)V

    invoke-interface {v1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 10
    new-instance v12, Lorw;
    ...
    invoke-direct/range {v0 .. v11}, Lorw;-><init>(Ljava/util/List;Lhrw;Lkrw;Lokhttp3/internal/connection/RealConnection;ILokhttp3/Request;Lokhttp3/Call;Lokhttp3/EventListener;III)V
...
.method public streamAllocation()Lhrw;
    .locals 1

    .line 1
    iget-object v0, p0, Lokhttp3/RealCall;->retryAndFollowUpInterceptor:Lrrw;

    invoke-virtual {v0}, Lrrw;->j()Lhrw;
