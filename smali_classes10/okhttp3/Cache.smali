...
# instance fields
.field public final cache:Lzqw;

.field private hitCount:I

.field public final internalCache:Lbrw;
...
.method public constructor <init>(Ljava/io/File;J)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lokhttp3/Cache;-><init>(Ljava/io/File;JLisw;)V

    return-void
.end method

.method public constructor <init>(Ljava/io/File;JLisw;)V
    .locals 7
    ...
    iput-object v0, p0, Lokhttp3/Cache;->internalCache:Lbrw;
    ...
    .line 4
    invoke-static/range {v1 .. v6}, Lzqw;->c(Lisw;Ljava/io/File;IIJ)Lzqw;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/Cache;->cache:Lzqw;

    return-void
.end method

.method private abortQuietly(Lzqw$d;)V
    .locals 0
    .param p1    # Lzqw$d;
...
.method public close()V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/Cache;->cache:Lzqw;

    invoke-virtual {v0}, Lzqw;->close()V
...
.method public directory()Ljava/io/File;
    ...
    invoke-virtual {v0}, Lzqw;->j()Ljava/io/File;
...
.method public flush()V
    ...
    invoke-virtual {v0}, Lzqw;->flush()V
...
.method public get(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    .line 2
    :try_start_0
    iget-object v2, p0, Lokhttp3/Cache;->cache:Lzqw;

    invoke-virtual {v2, v0}, Lzqw;->h(Ljava/lang/String;)Lzqw$f;
    ...
    invoke-virtual {v0, v3}, Lzqw$f;->c(I)Lokio/Source;
    ...
    .line 4
    invoke-virtual {v2, v0}, Lokhttp3/Cache$Entry;->response(Lzqw$f;)Lokhttp3/Response;
    ...
    invoke-static {p1}, Luqw;->g(Ljava/io/Closeable;)V
...
.method public isClosed()Z
    ...
    invoke-virtual {v0}, Lzqw;->isClosed()Z
...
.method public put(Lokhttp3/Response;)Lxqw;
    .locals 3
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
    ...
    invoke-static {v1}, Lnrw;->a(Ljava/lang/String;)Z
    ...
    .line 5
    :cond_1
    invoke-static {p1}, Lmrw;->e(Lokhttp3/Response;)Z
    ...
    .line 7
    :try_start_1
    iget-object v1, p0, Lokhttp3/Cache;->cache:Lzqw;
    ...
    invoke-virtual {v1, p1}, Lzqw;->e(Ljava/lang/String;)Lzqw$d;
    ...
    :cond_3
    :try_start_2
    invoke-virtual {v0, p1}, Lokhttp3/Cache$Entry;->writeTo(Lzqw$d;)V

    .line 9
    new-instance v0, Lokhttp3/Cache$CacheRequestImpl;

    invoke-direct {v0, p0, p1}, Lokhttp3/Cache$CacheRequestImpl;-><init>(Lokhttp3/Cache;Lzqw$d;)V
    :try_end_2
    ...
    .line 10
    :catch_2
    invoke-direct {p0, p1}, Lokhttp3/Cache;->abortQuietly(Lzqw$d;)V
...
.method public remove(Lokhttp3/Request;)V
    ...
    invoke-virtual {v0, p1}, Lzqw;->w(Ljava/lang/String;)Z
...
.method public declared-synchronized trackResponse(Lyqw;)V
    .locals 1
    ...
    .line 2
    iget-object v0, p1, Lyqw;->a:Lokhttp3/Request;
    ...
    .line 4
    :cond_0
    iget-object p1, p1, Lyqw;->b:Lokhttp3/Response;
...
.method public update(Lokhttp3/Response;Lokhttp3/Response;)V
    ...
    iget-object p1, p1, Lokhttp3/Cache$CacheResponseBody;->snapshot:Lzqw$f;

    .line 3
    :try_start_0
    invoke-virtual {p1}, Lzqw$f;->b()Lzqw$d;
