...
.field public final certificateChainCleaner:Lssw;
...
.method public static constructor <clinit>()V
    ...
    invoke-static {v1}, Luqw;->u([Ljava/lang/Object;)Ljava/util/List;
    ...
    sput-object v0, Lsqw;->instance:Lsqw;
...
.method public constructor <init>(Lokhttp3/OkHttpClient$Builder;)V
    ...
    invoke-static {v1}, Luqw;->t(Ljava/util/List;)Ljava/util/List;
    ...
    .line 13
    iget-object v1, p1, Lokhttp3/OkHttpClient$Builder;->internalCache:Lbrw;

    iput-object v1, p0, Lokhttp3/OkHttpClient;->internalCache:Lbrw;
    ...
    .line 18
    :cond_3
    invoke-static {}, Luqw;->C()Ljavax/net/ssl/X509TrustManager;
    ...
    .line 20
    invoke-static {v0}, Lssw;->b(Ljavax/net/ssl/X509TrustManager;)Lssw;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/OkHttpClient;->certificateChainCleaner:Lssw;
    ...
    .line 22
    iget-object v0, p1, Lokhttp3/OkHttpClient$Builder;->certificateChainCleaner:Lssw;
    ...
    invoke-virtual {v0, v1}, Losw;->g(Ljavax/net/ssl/SSLSocketFactory;)V
    ...
    iget-object v1, p0, Lokhttp3/OkHttpClient;->certificateChainCleaner:Lssw;

    invoke-virtual {v0, v1}, Lokhttp3/CertificatePinner;->withCertificateChainCleaner(Lssw;)Lokhttp3/CertificatePinner;
...
.method private static newSslSocketFactory(Ljavax/net/ssl/X509TrustManager;)Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-virtual {v0}, Losw;->m()Ljavax/net/ssl/SSLContext;
    ...
    .line 4
    invoke-static {v0, p0}, Luqw;->b(Ljava/lang/String;Ljava/lang/Exception;)Ljava/lang/AssertionError;
...
.method public internalCache()Lbrw;
    .locals 1
    ...
    iget-object v0, v0, Lokhttp3/Cache;->internalCache:Lbrw;

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lokhttp3/OkHttpClient;->internalCache:Lbrw;
...
.method public newWebSocket(Lokhttp3/Request;Lokhttp3/WebSocketListener;)Lokhttp3/WebSocket;
    ...
    invoke-direct/range {v0 .. v5}, Lvsw;-><init>(Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;J)V

    .line 2
    invoke-virtual {v6, p0}, Lvsw;->h(Lokhttp3/OkHttpClient;)V
