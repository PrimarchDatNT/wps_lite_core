...
# static fields
.field public static final b:Lv6v;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2, v3}, Lv6v;-><init>(III)V

    sput-object v0, Lu6v;->b:Lv6v;
...
.method public constructor <init>(Lcom/linecorp/linesdk/auth/internal/LineAuthenticationStatus;)V
    ...
    .line 2
    iput-object p1, p0, Lu6v;->a:Lcom/linecorp/linesdk/auth/internal/LineAuthenticationStatus;
...
# virtual methods
.method public b(Lcom/linecorp/linesdk/auth/LineAuthenticationConfig;Li7v;Lcom/linecorp/linesdk/auth/LineAuthenticationParams;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    .locals 7
    ...
    invoke-static {p2}, Le6v;->d(Ljava/util/List;)Ljava/lang/String;
    ...
    .line 9
    invoke-static {p4, p2}, Lg8v;->c(Ljava/lang/String;Ljava/util/Map;)Landroid/net/Uri;
    ...
    .line 12
    invoke-static {p4}, Lg8v;->d([Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {p1, p2}, Lg8v;->b(Landroid/net/Uri;Ljava/util/Map;)Landroid/net/Uri;
...
.method public d(Landroid/content/Context;Landroid/net/Uri;Z)Lu6v$a;
    .locals 7
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 3
    invoke-static {p1, v3}, Lu6;->d(Landroid/content/Context;I)I

    move-result v3

    invoke-virtual {v0, v3}, Lv2$a;->b(I)Lv2$a;
    ...
    .line 6
    iget-object v0, v0, Lv2;->b:Landroid/os/Bundle;
    ...
    .line 8
    :goto_0
    invoke-static {p1}, Lv6v;->a(Landroid/content/Context;)Lv6v;
    ...
    .line 9
    new-instance p1, Lu6v$a;

    invoke-direct {p1, v3, v0, v5}, Lu6v$a;-><init>(Landroid/content/Intent;Landroid/os/Bundle;Z)V
    ...
    .line 10
    sget-object p3, Lu6v;->b:Lv6v;

    .line 11
    invoke-virtual {v4, p3}, Lv6v;->b(Lv6v;)Z
    ...
    .line 15
    new-instance p2, Lu6v$a;

    invoke-direct {p2, p1, v0, v6}, Lu6v$a;-><init>(Landroid/content/Intent;Landroid/os/Bundle;Z)V
    ...
    invoke-static {p2, p1, p3}, Lu6v;->a(Landroid/net/Uri;Ljava/util/Collection;Landroid/os/Bundle;)Ljava/util/List;
    ...
    invoke-direct {p2, p1, v0, v5}, Lu6v$a;-><init>(Landroid/content/Intent;Landroid/os/Bundle;Z)V
    ...
    invoke-direct {p1, p2, v0, v5}, Lu6v$a;-><init>(Landroid/content/Intent;Landroid/os/Bundle;Z)V
...
.method public e(Landroid/content/Intent;)Lu6v$c;
    .locals 4
    ...
    .line 2
    invoke-static {p1}, Lu6v$c;->c(Ljava/lang/String;)Lu6v$c;
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lu6v;->a:Lcom/linecorp/linesdk/auth/internal/LineAuthenticationStatus;
    ...
    .line 11
    invoke-static {v0, v2}, Lu6v$c;->d(Ljava/lang/String;Ljava/lang/Boolean;)Lu6v$c;
    ...
    .line 14
    invoke-static {v0, p1}, Lu6v$c;->b(Ljava/lang/String;Ljava/lang/String;)Lu6v$c;
...
.method public f(Landroid/content/Context;Lcom/linecorp/linesdk/auth/LineAuthenticationConfig;Li7v;Lcom/linecorp/linesdk/auth/LineAuthenticationParams;)Lu6v$b;
    .locals 8
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 1
    invoke-static {v0}, Lu5v;->a(I)Ljava/lang/String;

    move-result-object v5

    .line 2
    iget-object v1, p0, Lu6v;->a:Lcom/linecorp/linesdk/auth/internal/LineAuthenticationStatus;
    ...
    .line 8
    invoke-virtual {p0, p1}, Lu6v;->c(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 9
    invoke-virtual/range {v1 .. v7}, Lu6v;->b(Lcom/linecorp/linesdk/auth/LineAuthenticationConfig;Li7v;Lcom/linecorp/linesdk/auth/LineAuthenticationParams;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 11
    invoke-virtual {p0, p1, p3, p2}, Lu6v;->d(Landroid/content/Context;Landroid/net/Uri;Z)Lu6v$a;

    move-result-object p1

    .line 12
    new-instance p2, Lu6v$b;

    .line 13
    invoke-virtual {p1}, Lu6v$a;->b()Landroid/content/Intent;

    move-result-object p3

    .line 14
    invoke-virtual {p1}, Lu6v$a;->c()Landroid/os/Bundle;

    move-result-object p4

    .line 15
    invoke-static {p1}, Lu6v$a;->a(Lu6v$a;)Z

    move-result p1

    invoke-direct {p2, p3, p4, v0, p1}, Lu6v$b;-><init>(Landroid/content/Intent;Landroid/os/Bundle;Ljava/lang/String;Z)V
