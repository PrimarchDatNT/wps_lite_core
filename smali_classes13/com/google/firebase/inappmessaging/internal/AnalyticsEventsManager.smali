...
.field private final flowable:Ltiw;
...
.method public constructor <init>(Lcom/google/firebase/analytics/connector/AnalyticsConnector;)V
    ...
    .line 4
    sget-object v0, Ljhw;->S:Ljhw;

    invoke-static {p1, v0}, Lohw;->e(Lqhw;Ljhw;)Lohw;

    move-result-object p1

    invoke-virtual {p1}, Lohw;->C()Ltiw;

    move-result-object p1

    iput-object p1, p0, Lcom/google/firebase/inappmessaging/internal/AnalyticsEventsManager;->flowable:Ltiw;

    .line 5
    invoke-virtual {p1}, Ltiw;->K()Ljiw;
...
.method public static extractAnalyticsEventNames(Lxnu;)Ljava/util/Set;
    .locals 4
    .annotation build Lcom/google/common/annotations/VisibleForTesting;
    .end annotation
    ...
    .line 3
    invoke-virtual {v1}, Lrnu;->g()Ljava/util/List;
...
# virtual methods
.method public getAnalyticsEventsFlowable()Ltiw;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 1
    iget-object v0, p0, Lcom/google/firebase/inappmessaging/internal/AnalyticsEventsManager;->flowable:Ltiw;
...
.method public updateContextualTriggers(Lxnu;)V
    .locals 2

    .line 1
    invoke-static {p1}, Lcom/google/firebase/inappmessaging/internal/AnalyticsEventsManager;->extractAnalyticsEventNames(Lxnu;)Ljava/util/Set;
