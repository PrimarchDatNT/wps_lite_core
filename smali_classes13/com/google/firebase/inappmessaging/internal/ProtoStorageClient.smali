...
.method public static synthetic lambda$read$1(Lcom/google/firebase/inappmessaging/internal/ProtoStorageClient;Lbqu;)Laou;
    .locals 2
    ...
    .line 3
    :try_start_1
    invoke-interface {p1, v0}, Lbqu;->c(Ljava/io/InputStream;)Ljava/lang/Object;
    ...
    throw p1
    :try_end_5
    .catch Lcpu; {:try_start_5 .. :try_end_5} :catch_1
...
.method public static synthetic lambda$write$0(Lcom/google/firebase/inappmessaging/internal/ProtoStorageClient;Laou;)Ljava/lang/Object;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    .line 3
    :try_start_1
    invoke-virtual {p1}, Laou;->toByteArray()[B
...
.method public read(Lbqu;)Lshw;
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/google/firebase/inappmessaging/internal/ProtoStorageClient$$Lambda$2;->lambdaFactory$(Lcom/google/firebase/inappmessaging/internal/ProtoStorageClient;Lbqu;)Ljava/util/concurrent/Callable;

    move-result-object p1

    invoke-static {p1}, Lshw;->l(Ljava/util/concurrent/Callable;)Lshw;
...
.method public write(Laou;)Lkhw;
    .locals 0

    .line 1
    invoke-static {p0, p1}, Lcom/google/firebase/inappmessaging/internal/ProtoStorageClient$$Lambda$1;->lambdaFactory$(Lcom/google/firebase/inappmessaging/internal/ProtoStorageClient;Laou;)Ljava/util/concurrent/Callable;

    move-result-object p1

    invoke-static {p1}, Lkhw;->k(Ljava/util/concurrent/Callable;)Lkhw;
