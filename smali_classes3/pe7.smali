...
.method public a()Z
    ...
    .line 1
    invoke-virtual {p0}, Lpe7;->b()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lpe7;->d()Z
...
.method public b()Z
    ...
    const-string v1, "key_unlogin_linktext_cache"
...
.method public c(Z)V
    ...
    invoke-virtual {v0, v1, p1}, Lkm8;->A(Ljava/lang/String;Z)V
...
.method public d()Z
    ...
    const-string v0, "strength_cloud_unlogin_switch"
...
.method public e()Lqe7$c;
    ...
    const-string v1, "unlogin_use_new_guide"
    ...
    iput-boolean v1, v0, Lqe7$c;->c:Z

    const-string v1, "text_link_content_unlogin"
    ...
    const-string v1, "text_link_url_unlogin"
    ...
    const-string v3, "Unlogin param on, get param is: "
    ...
    :cond_0
    const-string v0, "Unlogin param off. "
