...
.field public final synthetic k:Limo;
...
.method public constructor <init>(Limo;)V
    ...
    .line 1
    iput-object p1, p0, Limo$a;->k:Limo;
...
.method public m(Ljlo;Ljlo;)Z
    ...
    .line 1
    iget-object v0, p0, Limo$a;->k:Limo;

    iget-object v0, v0, Limo;->t:Ljava/nio/FloatBuffer;
    ...
    iget-object v0, v0, Limo;->u:Ljava/nio/FloatBuffer;
    ...
    invoke-virtual {p0, v0, v2, v3}, Limo$a;->u(Ljava/nio/FloatBuffer;II)V

    .line 5
    invoke-virtual {p0, p1, p2}, Limo$a;->w(Ljlo;Ljlo;)V
...
.method public t()V
    ...
    .line 1
    invoke-virtual {p0}, Limo$a;->v()Ljlo;
    ...
    iget-object v0, v0, Limo;->q:Lymo;

    invoke-virtual {v0}, Lymo;->L()Lxmo;

    move-result-object v0

    iget-object v1, p0, Limo$a;->k:Limo;

    iget-object v1, v1, Limo;->q:Lymo;
    ...
    invoke-virtual {v0, v2, v2, v1, v3}, Lxmo;->o(Lxmo$a;Lxmo$b;IZ)V
    ...
    :goto_2
    const-string v1, "uLightList[1].isLegacy3d"

    invoke-virtual {p0, v1, v3}, Lwlo;->f(Ljava/lang/String;F)V
...
.method public w(Ljlo;Ljlo;)V
    ...
    .line 1
    invoke-virtual/range {v0 .. v7}, Limo$a;->c(ILjlo;Ljlo;FFFF)V

    .line 2
    iget-object p1, p0, Limo$a;->k:Limo;

    invoke-static {p1}, Limo;->n(Limo;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v1}, Limo$a;->x(Z)V
...
.method public y()V
    ...
    invoke-virtual {v0}, Limo;->l()Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Limo$a;->k:Limo;

    invoke-virtual {v1}, Limo;->m()Ljava/lang/String;
