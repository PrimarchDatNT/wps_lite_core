...
# virtual methods
.method public a(Landroid/text/TextPaint;Landroid/graphics/Matrix;)V
    .locals 7

    .line 1
    iget-object v0, p0, Loip;->a:Lphp;

    invoke-virtual {v0}, Lphp;->c()Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v0}, Lphp;->b()I

    move-result v0

    .line 4
    invoke-virtual {p0, v0}, Loip;->c(I)Ljava/lang/String;
    ...
    .line 8
    :cond_1
    iget-object v4, p0, Loip;->a:Lphp;

    invoke-virtual {v4}, Lphp;->a()I

    move-result v4

    .line 9
    iget-object v5, p0, Loip;->a:Lphp;

    invoke-virtual {v5}, Lphp;->d()I

    move-result v5

    .line 10
    invoke-virtual {p0, v0, v4, v5}, Loip;->b(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    .line 12
    new-instance v5, Loip$b;

    const/4 v6, 0x0

    invoke-direct {v5, p0, v6}, Loip$b;-><init>(Loip;Loip$a;)V

    invoke-virtual {v5, p2, v0}, Loip$b;->a(Landroid/graphics/Matrix;[F)V
