...
.super Lcom/facebook/login/h;
.source "DeviceLoginManager.java"


# static fields
.field public static volatile i:Lcom/facebook/login/c;
...
.method public constructor <init>()V
    ...
    .line 1
    invoke-direct {p0}, Lcom/facebook/login/h;-><init>()V

    return-void
.end method

.method public static C()Lcom/facebook/login/c;
    .locals 3
    ...
    sput-object v1, Lcom/facebook/login/c;->i:Lcom/facebook/login/c;
    ...
    :cond_2
    :goto_0
    sget-object v0, Lcom/facebook/login/c;->i:Lcom/facebook/login/c;
    :try_end_2
...
.method public A()Ljava/lang/String;
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lcom/facebook/login/c;->h:Ljava/lang/String;
    :try_end_0
...
.method public B()Landroid/net/Uri;
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lcom/facebook/login/c;->g:Landroid/net/Uri;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public D(Landroid/net/Uri;)V
    ...
    :cond_0
    :try_start_0
    iput-object p1, p0, Lcom/facebook/login/c;->g:Landroid/net/Uri;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public b(Ljava/util/Collection;)Lcom/facebook/login/LoginClient$Request;
    ...
    :cond_0
    :try_start_0
    invoke-super {p0, p1}, Lcom/facebook/login/h;->b(Ljava/util/Collection;)Lcom/facebook/login/LoginClient$Request;

    move-result-object p1

    .line 2
    invoke-virtual {p0}, Lcom/facebook/login/c;->B()Landroid/net/Uri;
    ...
    .line 4
    :cond_1
    invoke-virtual {p0}, Lcom/facebook/login/c;->A()Ljava/lang/String;
