...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/facebook/login/DeviceAuthDialog;->I2(Ljava/lang/String;Ljava/lang/Long;Ljava/lang/Long;)V
.end annotation
...
.method public a(Llqq;)V
    ...
    invoke-static {v0}, Lcom/facebook/login/DeviceAuthDialog;->w2(Lcom/facebook/login/DeviceAuthDialog;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v0, p1}, Lcom/facebook/login/DeviceAuthDialog;->H2(Lcqq;)V
    ...
    .line 6
    invoke-static {p1}, Lcom/facebook/internal/i0;->G(Lorg/json/JSONObject;)Lcom/facebook/internal/i0$e;
    ...
    invoke-static {p1}, Lcom/facebook/login/DeviceAuthDialog;->y2(Lcom/facebook/login/DeviceAuthDialog;)Lcom/facebook/login/DeviceAuthDialog$RequestState;
    ...
    invoke-static {p1}, Ltsq;->a(Ljava/lang/String;)V
    ...
    .line 11
    invoke-virtual {p1}, Lcom/facebook/internal/p;->o()Ljava/util/EnumSet;

    move-result-object p1

    sget-object v0, Lcom/facebook/internal/g0;->T:Lcom/facebook/internal/g0;
    ...
    invoke-static {p1}, Lcom/facebook/login/DeviceAuthDialog;->s2(Lcom/facebook/login/DeviceAuthDialog;)Z
    ...
    invoke-static {p1, v0}, Lcom/facebook/login/DeviceAuthDialog;->t2(Lcom/facebook/login/DeviceAuthDialog;Z)Z
    ...
    invoke-static/range {v1 .. v7}, Lcom/facebook/login/DeviceAuthDialog;->u2(Lcom/facebook/login/DeviceAuthDialog;Ljava/lang/String;Lcom/facebook/internal/i0$e;Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V
    ...
    invoke-static/range {v1 .. v6}, Lcom/facebook/login/DeviceAuthDialog;->C2(Lcom/facebook/login/DeviceAuthDialog;Ljava/lang/String;Lcom/facebook/internal/i0$e;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V
    ...
    invoke-virtual {v0, v1}, Lcom/facebook/login/DeviceAuthDialog;->H2(Lcqq;)V
