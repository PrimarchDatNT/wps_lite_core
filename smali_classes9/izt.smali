...
.method public static a(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0, v1}, Lizt;->e(Landroid/content/Context;[ILjava/lang/String;)V
...
.method public static b(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 1
    sget-object v0, Lcn/wps/moffice_eng/R$styleable;->ThemeEnforcement:[I
    ...
    .line 8
    :cond_0
    invoke-static {p0}, Lizt;->c(Landroid/content/Context;)V

    .line 9
    :cond_1
    invoke-static {p0}, Lizt;->a(Landroid/content/Context;)V
...
.method public static varargs d(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)V
    ...
    .line 6
    :cond_1
    invoke-static/range {p0 .. p5}, Lizt;->f(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Z
...
.method public static e(Landroid/content/Context;[ILjava/lang/String;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lizt;->g(Landroid/content/Context;[I)Z
...
.method public static varargs h(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;
    ...
    .line 1
    invoke-static {p0, p1, p3, p4}, Lizt;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    .line 2
    invoke-static/range {p0 .. p5}, Lizt;->d(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)V
...
.method public static varargs i(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Lf2;
    .locals 0
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 3
    invoke-static {p0, p1, p2, p3, p4}, Lf2;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lf2;
