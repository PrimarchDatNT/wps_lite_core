...
# direct methods
.method public constructor <init>(Landroid/content/Context;Labu;Lx7u;[B)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lv7u;->a:Labu;

    iput-object p1, p0, Lv7u;->b:Landroid/content/Context;
...
.method public final b()Z
    ...
    :try_start_0
    iget-object v4, p0, Lv7u;->a:Labu;

    invoke-virtual {v4}, Labu;->i()Ljava/io/File;
    ...
    :try_start_1
    iget-object v6, p0, Lv7u;->b:Landroid/content/Context;

    invoke-virtual {v6}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v6

    iget-object v7, p0, Lv7u;->b:Landroid/content/Context;
    ...
    invoke-static {v9}, Lv7u;->a(Landroid/content/pm/Signature;)Ljava/security/cert/X509Certificate;
    ...
    :try_start_3
    invoke-static {v8}, Lw9u;->m(Ljava/lang/String;)[[Ljava/security/cert/X509Certificate;
    ...
    :cond_7
    :try_start_5
    iget-object v8, p0, Lv7u;->a:Labu;

    invoke-virtual {v8, v7}, Labu;->a(Ljava/io/File;)Ljava/io/File;
...
.method public final c(Ljava/util/List;)Z
    ...
    iget-object v1, p0, Lv7u;->a:Labu;

    invoke-virtual {v1, v0}, Labu;->g(Ljava/lang/String;)Ljava/io/File;
