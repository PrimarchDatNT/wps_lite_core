...
.method public static a()Lw7u;
    ...
    invoke-direct {v0}, Ln8u;-><init>()V

    return-object v0

    :pswitch_2
    new-instance v0, Lk8u;

    invoke-direct {v0}, Lk8u;-><init>()V

    return-object v0

    :pswitch_3
    new-instance v0, Lj8u;

    invoke-direct {v0}, Lj8u;-><init>()V

    return-object v0

    :pswitch_4
    new-instance v0, Li8u;

    invoke-direct {v0}, Li8u;-><init>()V

    return-object v0

    :pswitch_5
    new-instance v0, Ld8u;

    invoke-direct {v0}, Ld8u;-><init>()V

    return-object v0

    :pswitch_6
    new-instance v0, Lc8u;

    invoke-direct {v0}, Lc8u;-><init>()V

    return-object v0

    :cond_0
    :goto_0
    new-instance v0, Lq8u;

    invoke-direct {v0}, Lq8u;-><init>()V
...
.method public static c(Ld9u;Ljava/io/InputStream;Ljava/io/OutputStream;J)V
    .locals 13
    ...
    :goto_0
    invoke-direct {v0, v1}, Lc9u;-><init>(Ljava/lang/String;)V
    ...
    :try_start_1
    invoke-static/range {v1 .. v6}, Lx7u;->e([BLjava/io/DataInputStream;Ljava/io/OutputStream;IJ)V
    ...
    invoke-static/range {v1 .. v8}, Lx7u;->d([BLd9u;Ljava/io/OutputStream;JIJ)V
...
.method public static d([BLd9u;Ljava/io/OutputStream;JIJ)V
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct/range {v4 .. v9}, Le9u;-><init>(Ld9u;JJ)V

    invoke-virtual {v2}, Ld9u;->c()Ljava/io/InputStream;
    ...
    :try_start_3
    invoke-static {v1, v2}, Lm9u;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
