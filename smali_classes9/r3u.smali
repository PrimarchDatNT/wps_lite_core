...
.method public constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object p1, p0, Lr3u;->B:Ljava/io/File;

    iput-object p2, p0, Lr3u;->I:Ljava/io/File;

    new-instance v0, Ljava/util/TreeMap;

    invoke-direct {v0}, Ljava/util/TreeMap;-><init>()V

    iput-object v0, p0, Lr3u;->S:Ljava/util/NavigableMap;

    invoke-static {p1, p2}, Lz5u;->a(Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    ...
    iget-object v1, p0, Lr3u;->S:Ljava/util/NavigableMap;
    ...
    invoke-direct {v0, p1}, Li4u;-><init>(Ljava/lang/String;)V
...
.method public final a()J
    ...
    iget-object v0, p0, Lr3u;->S:Ljava/util/NavigableMap;
...
.method public final b(JJ)Ljava/io/InputStream;
    ...
    new-instance v1, Lq3u;

    invoke-virtual {p0, p1, p2, v0}, Lr3u;->d(JLjava/lang/Long;)Ljava/io/InputStream;

    move-result-object p1

    invoke-direct {v1, p1, p3, p4}, Lq3u;-><init>(Ljava/io/InputStream;J)V
    ...
    iget-object v3, p0, Lr3u;->S:Ljava/util/NavigableMap;
    ...
    :cond_1
    new-instance v0, Lq3u;

    new-instance v3, Ljava/io/FileInputStream;

    iget-object v4, p0, Lr3u;->S:Ljava/util/NavigableMap;
    ...
    invoke-direct {v0, v3, p3, p4}, Lq3u;-><init>(Ljava/io/InputStream;J)V
    ...
    invoke-direct {p1, p2}, Li4u;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v2, p1}, Li4u;-><init>(Ljava/lang/String;)V
