...
.method public final a(ILandroid/os/Parcel;)Z
    ...
    invoke-direct {v2, p1}, Lmau;-><init>(Landroid/os/IBinder;)V

    :cond_2
    :goto_0
    invoke-interface {p0, v2}, Llau;->Nn(Lnau;)V
    ...
    invoke-direct {v2, p2}, Lmau;-><init>(Landroid/os/IBinder;)V

    :cond_5
    :goto_1
    invoke-interface {p0, p1, v2}, Llau;->Wm(Landroid/os/Bundle;Lnau;)V
