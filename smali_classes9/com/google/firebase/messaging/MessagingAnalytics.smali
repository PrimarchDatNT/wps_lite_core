...
.method public static logNotificationReceived(Landroid/content/Intent;)V
    ...
    .line 4
    invoke-static {}, Lcom/google/firebase/messaging/FirebaseMessaging;->getTransportFactory()Lvyq;
    ...
    .line 6
    invoke-static {v2}, Lqyq;->b(Ljava/lang/String;)Lqyq;

    move-result-object v2

    sget-object v3, Lcom/google/firebase/messaging/MessagingAnalytics$$Lambda$0;->$instance:Ltyq;

    const-string v4, "FCM_CLIENT_EVENT_LOGGING"

    .line 7
    invoke-interface {v0, v4, v1, v2, v3}, Lvyq;->getTransport(Ljava/lang/String;Ljava/lang/Class;Lqyq;Ltyq;)Luyq;
    ...
    .line 8
    invoke-static {v1, p0, v0}, Lcom/google/firebase/messaging/MessagingAnalytics;->logToFirelog(Ljava/lang/String;Landroid/content/Intent;Luyq;)V
...
.method private static logToFirelog(Ljava/lang/String;Landroid/content/Intent;Luyq;)V
    .locals 1
    ...
    invoke-static {p0}, Lryq;->e(Ljava/lang/Object;)Lryq;

    move-result-object p0

    invoke-interface {p2, p0}, Luyq;->send(Lryq;)V
    :try_end_0
