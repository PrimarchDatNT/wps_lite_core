...
.method private convertKeyValueList(Ljava/util/List;)Ljava/util/Map;
    ...
    invoke-virtual {v1}, Lcom/google/firebase/remoteconfig/proto/ConfigPersistence$KeyValue;->getValue()Liou;
    ...
    invoke-virtual {v1, v3}, Liou;->P(Ljava/nio/charset/Charset;)Ljava/lang/String;
...
.method private convertLegacyAbtExperiment(Lg8w;)Lorg/json/JSONObject;
    .locals 5
...
.method private convertLegacyAbtExperiments(Ljava/util/List;)Lorg/json/JSONArray;
    ...
    .line 3
    invoke-direct {p0, v1}, Lcom/google/firebase/remoteconfig/internal/LegacyConfigsHandler;->deserializePayload(Liou;)Lg8w;
    ...
    .line 4
    :try_start_0
    invoke-direct {p0, v1}, Lcom/google/firebase/remoteconfig/internal/LegacyConfigsHandler;->convertLegacyAbtExperiment(Lg8w;)Lorg/json/JSONObject;
...
.method private deserializePayload(Liou;)Lg8w;
    .locals 4
    ...
    .line 1
    :try_start_0
    invoke-virtual {p1}, Liou;->B()Liou$f;
    ...
    .line 4
    :cond_0
    invoke-static {v1}, Lg8w;->i([B)Lg8w;
