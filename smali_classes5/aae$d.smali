...
.method public constructor <init>(Laae;Ljava/util/List;)V
    ...
    .line 1
    iput-object p1, p0, Laae$d;->b:Laae;

    iput-object p2, p0, Laae$d;->a:Ljava/util/List;
...
.method public a(Lqdf;)Z
    ...
    .line 5
    iget-object v2, p0, Laae$d;->b:Laae;

    iget-boolean v2, v2, Laae;->Z:Z
    ...
    .line 6
    iget-object v2, p0, Laae$d;->a:Ljava/util/List;
    ...
    :cond_1
    const-string v2, "ppt_page2picture_output_success"
    ...
    iget-object v2, v2, Laae;->b0:Ljava/lang/String;
    ...
    .line 22
    iget-object p1, p0, Laae$d;->b:Laae;

    iget-object v0, p0, Laae$d;->a:Ljava/util/List;

    iget-object v1, p1, Laae;->c0:Ljava/lang/Runnable;

    invoke-virtual {p1, v0, v1}, Laae;->C(Ljava/util/List;Ljava/lang/Runnable;)V

    goto :goto_3

    .line 23
    :cond_3
    iget-object v0, p0, Laae$d;->b:Laae;

    iget-object v1, p0, Laae$d;->a:Ljava/util/List;

    invoke-virtual {v0, p1, v1}, Laae;->x(Lpdf;Ljava/util/List;)V
