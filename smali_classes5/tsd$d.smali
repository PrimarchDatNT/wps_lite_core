...
.method public constructor <init>(Ltsd;Ltsd$i;Lorg/json/JSONArray;I)V
    ...
    .line 1
    iput-object p1, p0, Ltsd$d;->T:Ltsd;

    iput-object p2, p0, Ltsd$d;->B:Ltsd$i;

    iput-object p3, p0, Ltsd$d;->I:Lorg/json/JSONArray;

    iput p4, p0, Ltsd$d;->S:I
...
.method public run()V
    ...
    .line 2
    iget-object v1, p0, Ltsd$d;->T:Ltsd;
    ...
    .line 4
    iget-object v2, p0, Ltsd$d;->B:Ltsd$i;
    ...
    new-instance v2, Ltsd$d$a;

    invoke-direct {v2, p0}, Ltsd$d$a;-><init>(Ltsd$d;)V
    ...
    .line 15
    iget-object v4, p0, Ltsd$d;->I:Lorg/json/JSONArray;
    ...
    .line 18
    :try_start_1
    iget-object v2, p0, Ltsd$d;->T:Ltsd;
    ...
    new-instance v3, Ltsd$d$b;

    invoke-direct {v3, p0}, Ltsd$d$b;-><init>(Ltsd$d;)V
    ...
    invoke-virtual {v2}, Lvsd$a;->b()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lvsd$a;->a()Ljava/lang/String;

    move-result-object v1

    iget-object v3, p0, Ltsd$d;->B:Ltsd$i;

    iget-object v4, v3, Ltsd$i;->b:Ljava/lang/String;

    iget-object v3, v3, Ltsd$i;->d:Ljava/lang/String;

    invoke-direct {v0, v2, v1, v4, v3}, Ltsd$g;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Ltsd$d;->B:Ltsd$i;
