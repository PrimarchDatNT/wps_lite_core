...
.method public constructor <init>(FFF)V
    ...
    iput-object p3, p0, Lfah;->d:Landroid/graphics/Path;
...
.method public constructor <init>(FFFLbah;FFLandroid/graphics/PointF;)V
    .locals 0
    ...
    .line 15
    iput-object p7, p0, Lfah;->h:Landroid/graphics/PointF;
    ...
    iget-object p2, p0, Lfah;->e:Lbah;

    invoke-virtual {p2}, Lbah;->f()F

    move-result p2

    iget-object p4, p0, Lfah;->e:Lbah;

    invoke-virtual {p4}, Lbah;->d()F
...
.method public constructor <init>(FFFLbah;FLandroid/graphics/PointF;)V
    .locals 0
    ...
    .line 25
    iput-object p6, p0, Lfah;->h:Landroid/graphics/PointF;
    ...
    invoke-virtual {p4}, Lbah;->f()F

    move-result p4

    add-float/2addr p4, p2

    iget-object p6, p0, Lfah;->e:Lbah;

    invoke-virtual {p6}, Lbah;->d()F
...
# virtual methods
.method public a(Landroid/text/TextPaint;Le9h;F)V
    .locals 6

    .line 1
    invoke-virtual {p2}, Le9h;->c()[I

    move-result-object v3

    .line 2
    invoke-virtual {p2}, Le9h;->g()[F

    move-result-object v4

    .line 3
    sget-object v0, Lfah$a;->a:[I

    invoke-virtual {p2}, Le9h;->f()Le9h$a;
    ...
    .line 4
    :cond_0
    invoke-virtual {p2}, Le9h;->e()Landroid/graphics/RectF;

    move-result-object p3

    invoke-virtual {p2}, Le9h;->j()Landroid/graphics/RectF;

    move-result-object p2

    invoke-virtual {p0, p3, p2, v3, v4}, Lfah;->e(Landroid/graphics/RectF;Landroid/graphics/RectF;[I[F)Landroid/graphics/Bitmap;
    ...
    .line 8
    iget-object v0, p0, Lfah;->e:Lbah;

    invoke-virtual {v0}, Lbah;->e()Landroid/graphics/RectF;
    ...
    .line 10
    iget-object v0, p0, Lfah;->h:Landroid/graphics/PointF;
    ...
    .line 22
    :cond_4
    invoke-virtual {p0, v3, v4, p2}, Lfah;->h([I[FLe9h;)Landroid/graphics/RadialGradient;
    ...
    .line 24
    :cond_5
    invoke-virtual {p0}, Lfah;->f()Landroid/graphics/RectF;
    ...
    invoke-virtual/range {v0 .. v5}, Lfah;->g(ILandroid/graphics/RectF;[I[FF)Landroid/graphics/LinearGradient;
...
.method public final b(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;[I[F)V
    ...
    .line 2
    invoke-virtual {v0, v3, v4, v5}, Lfah;->d(Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    .line 11
    iget-object v3, v0, Lfah;->d:Landroid/graphics/Path;
...
.method public final d(Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    .line 5
    invoke-virtual {p0, p3, p2, p1}, Lfah;->c(FLandroid/graphics/PointF;Landroid/graphics/PointF;)Landroid/graphics/PointF;
...
.method public final e(Landroid/graphics/RectF;Landroid/graphics/RectF;[I[F)Landroid/graphics/Bitmap;
    ...
    .line 1
    iget-object v0, v10, Lfah;->e:Lbah;
    ...
    iget v2, v10, Lfah;->c:F

    iget v3, v10, Lfah;->b:F

    add-float/2addr v3, v2

    iget v4, v10, Lfah;->a:F
    ...
    .line 3
    :cond_0
    invoke-virtual {v0}, Lbah;->f()F

    move-result v0

    .line 4
    iget-object v2, v10, Lfah;->e:Lbah;

    invoke-virtual {v2}, Lbah;->d()F
    ...
    .line 8
    :goto_2
    invoke-virtual {v10, v4, v0}, Lfah;->l(Landroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;

    move-result-object v4

    .line 9
    invoke-virtual {v10, v5, v0}, Lfah;->l(Landroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    .line 12
    iget v0, v10, Lfah;->c:F

    iget v2, v10, Lfah;->b:F
    ...
    invoke-virtual/range {v0 .. v9}, Lfah;->i(Landroid/graphics/Canvas;Landroid/graphics/Paint;[I[FLandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/RectF;)V
...
.method public final f()Landroid/graphics/RectF;
    ...
    .line 5
    iget-object v1, p0, Lfah;->e:Lbah;

    invoke-virtual {v1}, Lbah;->d()F

    move-result v1

    .line 6
    iget-object v2, p0, Lfah;->h:Landroid/graphics/PointF;
...
.method public final g(ILandroid/graphics/RectF;[I[FF)Landroid/graphics/LinearGradient;
    ...
    invoke-virtual {p0, p1, v1, v3}, Lfah;->c(FLandroid/graphics/PointF;Landroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    .line 6
    invoke-virtual/range {v0 .. v7}, Lfah;->k(Landroid/graphics/PointF;Landroid/graphics/PointF;FF[I[FF)Landroid/graphics/LinearGradient;
...
.method public final h([I[FLe9h;)Landroid/graphics/RadialGradient;
    .locals 19
    ...
    invoke-virtual/range {p3 .. p3}, Le9h;->e()Landroid/graphics/RectF;
    ...
    iget v12, v0, Lfah;->c:F

    invoke-direct {v11, v12, v8}, Landroid/graphics/PointF;-><init>(FF)V

    invoke-virtual {v0, v10, v11}, Lfah;->m(Landroid/graphics/PointF;Landroid/graphics/PointF;)F
    ...
    iget v11, v0, Lfah;->c:F

    iget v12, v0, Lfah;->b:F

    add-float/2addr v11, v12

    iget v12, v0, Lfah;->a:F

    invoke-direct {v6, v11, v12}, Landroid/graphics/PointF;-><init>(FF)V

    invoke-virtual {v0, v10, v6}, Lfah;->m(Landroid/graphics/PointF;Landroid/graphics/PointF;)F
    ...
    iget v11, v0, Lfah;->a:F

    invoke-direct {v5, v6, v11}, Landroid/graphics/PointF;-><init>(FF)V

    invoke-virtual {v0, v10, v5}, Lfah;->m(Landroid/graphics/PointF;Landroid/graphics/PointF;)F
    ...
    .line 9
    :cond_0
    invoke-virtual {v3}, Lbah;->f()F

    move-result v3

    .line 10
    iget-object v9, v0, Lfah;->e:Lbah;

    invoke-virtual {v9}, Lbah;->d()F

    move-result v9

    .line 11
    iget v10, v0, Lfah;->f:F
    ...
    iget v14, v0, Lfah;->f:F

    invoke-direct {v13, v14, v8}, Landroid/graphics/PointF;-><init>(FF)V

    invoke-virtual {v0, v12, v13}, Lfah;->m(Landroid/graphics/PointF;Landroid/graphics/PointF;)F
    ...
    iget v13, v0, Lfah;->f:F

    add-float/2addr v13, v3

    invoke-direct {v6, v13, v9}, Landroid/graphics/PointF;-><init>(FF)V

    invoke-virtual {v0, v12, v6}, Lfah;->m(Landroid/graphics/PointF;Landroid/graphics/PointF;)F
    ...
    invoke-virtual {v0, v12, v3}, Lfah;->m(Landroid/graphics/PointF;Landroid/graphics/PointF;)F
    ...
    .line 23
    iget-object v3, v0, Lfah;->h:Landroid/graphics/PointF;
...
.method public final i(Landroid/graphics/Canvas;Landroid/graphics/Paint;[I[FLandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/RectF;)V
    ...
    .line 2
    invoke-virtual/range {v0 .. v7}, Lfah;->b(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;[I[F)V
    ...
    .line 5
    :cond_1
    invoke-virtual {v8, v3, v4, v5}, Lfah;->d(Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    invoke-virtual {v8, v7, v9, v10, v11}, Lfah;->j(FFFF)Z
    ...
    .line 17
    iget-object v0, v8, Lfah;->d:Landroid/graphics/Path;
