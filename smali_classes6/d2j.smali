...
.super Lv0j;
.source "HeaderTextboxDocumentImporter.java"
...
.method public constructor <init>(Lp0j;Luuh;)V
    ...
    :goto_0
    const-string p2, "mSubDocument.getType() == Document.HEADERTEXTBOX_DOCUMENT should be true!"
...
.method public p()V
    ...
    invoke-virtual {v1}, Lorg/apache/poi/hwpf/HWPFDocument;->getPlcffldHdrTxbx()Lorg/apache/poi/hwpf/model/PlcffldMom;
...
.method public q()V
    ...
    invoke-virtual {v3}, Lorg/apache/poi/hwpf/HWPFDocument;->getPlcfTxbxHdrBkd()Lorg/apache/poi/hwpf/model/PlcfTxbxBkd;
    ...
    .line 6
    invoke-virtual {v0, v4}, Lcn/wps/moffice/writer/core/TextDocument;->W4(I)Luuh;
    ...
    iget-object v5, p0, Lv0j;->c:Luuh;

    iget v6, p0, Lv0j;->i:I

    .line 7
    invoke-virtual/range {v1 .. v6}, Lm2j;->c(Lorg/apache/poi/hwpf/model/PlcftxbxTxt;Lorg/apache/poi/hwpf/model/PlcfTxbxBkd;Lrp5;Luuh;I)V
