...
.method public constructor <init>(Lp0j;Luuh;)V
    ...
    :goto_0
    const-string p2, "Document.ENDNOTE_DOCUMENT == mSubDocument.getType() should be true!"
...
.method public p()V
    ...
    invoke-virtual {v1}, Lorg/apache/poi/hwpf/HWPFDocument;->getPlcfFldEdn()Lorg/apache/poi/hwpf/model/PlcffldMom;
...
.method public q()V
    ...
    invoke-virtual {v1}, Lorg/apache/poi/hwpf/HWPFDocument;->getPlcfendRef()Lorg/apache/poi/hwpf/model/PlcffndEndRef;
    ...
    invoke-interface {v3}, Luuh;->p()Lmdi;

    move-result-object v3

    iget-object v4, p0, Lv0j;->c:Luuh;

    invoke-interface {v4}, Luuh;->z0()Lndi;
