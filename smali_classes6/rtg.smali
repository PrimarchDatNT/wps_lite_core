...
.method public constructor <init>(Lfsg;Lj3g;)V
    ...
    iput-object p1, p0, Lrtg;->U:Landroid/graphics/Point;
    ...
    iput-object p1, p0, Lrtg;->V:Landroid/graphics/Point;

    const/4 p1, 0x0

    .line 4
    iput-boolean p1, p0, Lrtg;->X:Z

    .line 5
    new-instance p1, Lrtg$a;

    invoke-direct {p1, p0}, Lrtg$a;-><init>(Lrtg;)V

    iput-object p1, p0, Lrtg;->Y:Liyg$b;
    ...
    iget-object v0, p0, Lrtg;->Y:Liyg$b;
...
.method public static synthetic b0(Lrtg;)Lkug;
    .locals 0

    .line 1
    invoke-virtual {p0}, Lrtg;->d0()Lkug;
...
.method public static synthetic c0(Lrtg;)Lf2n;
    .locals 0

    .line 1
    invoke-virtual {p0}, Lrtg;->e0()Lf2n;
...
.method public Q(Landroid/view/MotionEvent;)I
    ...
    .line 11
    invoke-virtual {p0, p1}, Lrtg;->i0(I)V

    .line 12
    invoke-virtual {p0}, Lrtg;->g0()V
    ...
    invoke-virtual/range {v4 .. v9}, Lrtg;->h0(IIIII)V
...
.method public R(Landroid/view/MotionEvent;)I
    ...
    iget-object v4, p0, Lrtg;->U:Landroid/graphics/Point;

    iget-object v5, p0, Lrtg;->V:Landroid/graphics/Point;

    .line 5
    invoke-static {v1, v2, v3, v4, v5}, Lpug;->d(Lf2n;Le9g;Lg3g;Landroid/graphics/Point;Landroid/graphics/Point;)V

    .line 6
    iget-object v1, p0, Lrtg;->U:Landroid/graphics/Point;
    ...
    .line 7
    iput-boolean v2, p0, Lrtg;->X:Z

    .line 8
    iget-object p1, p0, Lrtg;->W:Lnsg;
    ...
    .line 9
    :cond_0
    iget-object v1, p0, Lrtg;->V:Landroid/graphics/Point;
...
.method public W(Landroid/view/MotionEvent;Landroid/view/MotionEvent;FF)I
    ...
    .line 5
    :cond_0
    invoke-virtual {p0, p1}, Lrtg;->j0(Le2n;)V
...
.method public final h0(IIIII)V
    .locals 1
...
.method public final j0(Le2n;)V
    .locals 4

    if-eqz p1, :cond_0

    .line 1
    iget-object v0, p0, Lrtg;->W:Lnsg;
    ...
    iget-object v1, p0, Lrtg;->W:Lnsg;

    invoke-virtual {v1}, Lnsg;->b()I

    move-result v1

    iget-object v2, p0, Lrtg;->W:Lnsg;
