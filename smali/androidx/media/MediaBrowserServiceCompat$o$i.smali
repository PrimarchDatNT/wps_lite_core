...
.field public final synthetic T:Landroid/support/v4/os/ResultReceiver;

.field public final synthetic U:Landroidx/media/MediaBrowserServiceCompat$o;
...
.method public constructor <init>(Landroidx/media/MediaBrowserServiceCompat$o;Landroidx/media/MediaBrowserServiceCompat$p;Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/media/MediaBrowserServiceCompat$o$i;->U:Landroidx/media/MediaBrowserServiceCompat$o;

    iput-object p2, p0, Landroidx/media/MediaBrowserServiceCompat$o$i;->B:Landroidx/media/MediaBrowserServiceCompat$p;

    iput-object p3, p0, Landroidx/media/MediaBrowserServiceCompat$o$i;->I:Ljava/lang/String;

    iput-object p4, p0, Landroidx/media/MediaBrowserServiceCompat$o$i;->S:Landroid/os/Bundle;

    iput-object p5, p0, Landroidx/media/MediaBrowserServiceCompat$o$i;->T:Landroid/support/v4/os/ResultReceiver;
...
.method public run()V
    ...
    .line 2
    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$o$i;->U:Landroidx/media/MediaBrowserServiceCompat$o;
    ...
    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$o$i;->I:Ljava/lang/String;
    ...
    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$o$i;->S:Landroid/os/Bundle;
    ...
    iget-object v2, p0, Landroidx/media/MediaBrowserServiceCompat$o$i;->I:Ljava/lang/String;

    iget-object v3, p0, Landroidx/media/MediaBrowserServiceCompat$o$i;->S:Landroid/os/Bundle;

    iget-object v4, p0, Landroidx/media/MediaBrowserServiceCompat$o$i;->T:Landroid/support/v4/os/ResultReceiver;
