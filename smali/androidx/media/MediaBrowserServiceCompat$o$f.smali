...
.method public constructor <init>(Landroidx/media/MediaBrowserServiceCompat$o;Landroidx/media/MediaBrowserServiceCompat$p;ILjava/lang/String;ILandroid/os/Bundle;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->V:Landroidx/media/MediaBrowserServiceCompat$o;

    iput-object p2, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->B:Landroidx/media/MediaBrowserServiceCompat$p;

    iput p3, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->I:I

    iput-object p4, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->S:Ljava/lang/String;

    iput p5, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->T:I

    iput-object p6, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->U:Landroid/os/Bundle;
...
.method public run()V
    ...
    .line 2
    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->V:Landroidx/media/MediaBrowserServiceCompat$o;
    ...
    iget-object v1, v1, Landroidx/media/MediaBrowserServiceCompat;->S:Ljava/util/ArrayList;
    ...
    iget v5, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->I:I

    if-ne v4, v5, :cond_0

    .line 7
    iget-object v4, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->S:Ljava/lang/String;
    ...
    iget v4, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->T:I
    ...
    iget-object v4, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->V:Landroidx/media/MediaBrowserServiceCompat$o;
    ...
    iget-object v10, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->U:Landroid/os/Bundle;
    ...
    iget-object v5, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->S:Ljava/lang/String;

    iget v6, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->T:I

    iget v7, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->I:I

    iget-object v8, p0, Landroidx/media/MediaBrowserServiceCompat$o$f;->U:Landroid/os/Bundle;
