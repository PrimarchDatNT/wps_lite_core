...
.method public constructor <init>(Landroidx/media/MediaBrowserServiceCompat$o;Landroidx/media/MediaBrowserServiceCompat$p;Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/media/MediaBrowserServiceCompat$o$d;->T:Landroidx/media/MediaBrowserServiceCompat$o;

    iput-object p2, p0, Landroidx/media/MediaBrowserServiceCompat$o$d;->B:Landroidx/media/MediaBrowserServiceCompat$p;

    iput-object p3, p0, Landroidx/media/MediaBrowserServiceCompat$o$d;->I:Ljava/lang/String;

    iput-object p4, p0, Landroidx/media/MediaBrowserServiceCompat$o$d;->S:Landroid/os/IBinder;
...
.method public run()V
    ...
    .line 2
    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$o$d;->T:Landroidx/media/MediaBrowserServiceCompat$o;
    ...
    iget-object v2, p0, Landroidx/media/MediaBrowserServiceCompat$o$d;->I:Ljava/lang/String;
    ...
    .line 4
    :cond_0
    iget-object v2, p0, Landroidx/media/MediaBrowserServiceCompat$o$d;->T:Landroidx/media/MediaBrowserServiceCompat$o;

    iget-object v2, v2, Landroidx/media/MediaBrowserServiceCompat$o;->a:Landroidx/media/MediaBrowserServiceCompat;

    iget-object v3, p0, Landroidx/media/MediaBrowserServiceCompat$o$d;->I:Ljava/lang/String;

    iget-object v4, p0, Landroidx/media/MediaBrowserServiceCompat$o$d;->S:Landroid/os/IBinder;
