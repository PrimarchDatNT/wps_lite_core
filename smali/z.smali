...
.method public constructor <init>(Landroid/app/Activity;Z)V
    ...
    .line 12
    invoke-virtual {p0, p1}, Lz;->F(Landroid/view/View;)V
...
.method public A(Z)V
    ...
    .line 1
    iget-object v0, p0, Lz;->v:Ln0;

    if-eqz v0, :cond_0

    .line 2
    invoke-virtual {v0}, Ln0;->a()V
    ...
    invoke-virtual {p1, v2}, Lka;->n(F)Lka;

    .line 12
    iget-object v1, p0, Lz;->A:Lna;

    invoke-virtual {p1, v1}, Lka;->l(Lna;)Lka;

    .line 13
    invoke-virtual {v0, p1}, Ln0;->c(Lka;)Ln0;
    ...
    invoke-virtual {v0, p1}, Ln0;->f(Landroid/view/animation/Interpolator;)Ln0;

    const-wide/16 v1, 0xfa

    .line 17
    invoke-virtual {v0, v1, v2}, Ln0;->e(J)Ln0;

    .line 18
    iget-object p1, p0, Lz;->y:Lla;

    invoke-virtual {v0, p1}, Ln0;->g(Lla;)Ln0;

    .line 19
    iput-object v0, p0, Lz;->v:Ln0;
...
.method public B(Z)V
    ...
    invoke-direct {p1}, Ln0;-><init>()V

    .line 12
    iget-object v2, p0, Lz;->d:Landroidx/appcompat/widget/ActionBarContainer;

    invoke-static {v2}, Landroidx/core/view/ViewCompat;->d(Landroid/view/View;)Lka;

    move-result-object v2

    invoke-virtual {v2, v1}, Lka;->n(F)Lka;

    .line 13
    iget-object v3, p0, Lz;->A:Lna;

    invoke-virtual {v2, v3}, Lka;->l(Lna;)Lka;

    .line 14
    invoke-virtual {p1, v2}, Ln0;->c(Lka;)Ln0;
    ...
    invoke-virtual {v0, v1}, Lka;->n(F)Lka;

    invoke-virtual {p1, v0}, Ln0;->c(Lka;)Ln0;

    .line 18
    :cond_3
    sget-object v0, Lz;->C:Landroid/view/animation/Interpolator;

    invoke-virtual {p1, v0}, Ln0;->f(Landroid/view/animation/Interpolator;)Ln0;

    const-wide/16 v0, 0xfa

    .line 19
    invoke-virtual {p1, v0, v1}, Ln0;->e(J)Ln0;

    .line 20
    iget-object v0, p0, Lz;->z:Lla;

    invoke-virtual {p1, v0}, Ln0;->g(Lla;)Ln0;

    .line 21
    iput-object p1, p0, Lz;->v:Ln0;

    .line 22
    invoke-virtual {p1}, Ln0;->h()V
...
.method public final C(Landroid/view/View;)Lr1;
    .locals 3
...
.method public D()I
    ...
    .line 1
    iget-object v0, p0, Lz;->e:Lr1;

    invoke-interface {v0}, Lr1;->h()I
...
.method public final F(Landroid/view/View;)V
    ...
    invoke-virtual {p0, v0}, Lz;->C(Landroid/view/View;)Lr1;

    move-result-object v0

    iput-object v0, p0, Lz;->e:Lr1;
    ...
    .line 8
    iget-object p1, p0, Lz;->e:Lr1;

    invoke-interface {p1}, Lr1;->l()I
    ...
    invoke-static {v2}, Lg0;->b(Landroid/content/Context;)Lg0;
    ...
    :goto_2
    invoke-virtual {p0, p1}, Lz;->t(Z)V

    .line 12
    invoke-virtual {v2}, Lg0;->g()Z

    move-result p1

    invoke-virtual {p0, p1}, Lz;->J(Z)V
...
.method public G(Z)V
    ...
    .line 1
    :goto_0
    invoke-virtual {p0, p1, v0}, Lz;->H(II)V
...
.method public H(II)V
    ...
    invoke-interface {v1, p1}, Lr1;->g(I)V
...
.method public final J(Z)V
    ...
    invoke-interface {p1, v0}, Lr1;->s(Landroidx/appcompat/widget/ScrollingTabContainerView;)V
    ...
    :goto_3
    invoke-interface {v0, v3}, Lr1;->j(Z)V
...
.method public final N(Z)V
    ...
    invoke-static {v0, v1, v2}, Lz;->y(ZZZ)Z
...
.method public o(ILandroid/view/KeyEvent;)Z
    ...
    .line 2
    :cond_0
    invoke-virtual {v0}, Lz$d;->e()Landroid/view/Menu;
...
.method public r(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Lr1;->m(Landroid/view/View;)V
...
.method public t(Z)V
    ...
    invoke-interface {v0, p1}, Lr1;->r(Z)V
...
.method public u(Z)V
    ...
    .line 2
    iget-object p1, p0, Lz;->v:Ln0;

    if-eqz p1, :cond_0

    .line 3
    invoke-virtual {p1}, Ln0;->a()V
...
.method public w(Lh0$a;)Lh0;
    ...
    invoke-direct {v0, p0, v1, p1}, Lz$d;-><init>(Lz;Landroid/content/Context;Lh0$a;)V

    .line 6
    invoke-virtual {v0}, Lz$d;->t()Z
...
.method public x(Z)V
    ...
    .line 1
    invoke-virtual {p0}, Lz;->M()V

    goto :goto_0

    .line 2
    :cond_0
    invoke-virtual {p0}, Lz;->E()V

    .line 3
    :goto_0
    invoke-virtual {p0}, Lz;->L()Z
    ...
    invoke-interface {p1, v1, v4, v5}, Lr1;->p(IJ)Lka;
    ...
    invoke-virtual {v0, v3, v6, v7}, Landroidx/appcompat/widget/AbsActionBarView;->f(IJ)Lka;
    ...
    invoke-interface {p1, v3, v6, v7}, Lr1;->p(IJ)Lka;
    ...
    invoke-virtual {p1, v2, v4, v5}, Landroidx/appcompat/widget/AbsActionBarView;->f(IJ)Lka;
    ...
    .line 9
    invoke-virtual {v1, p1, v0}, Ln0;->d(Lka;Lka;)Ln0;

    .line 10
    invoke-virtual {v1}, Ln0;->h()V
    ...
    invoke-interface {p1, v1}, Lr1;->setVisibility(I)V
    ...
    invoke-interface {p1, v3}, Lr1;->setVisibility(I)V
...
.method public z()V
    ...
    .line 1
    iget-object v0, p0, Lz;->l:Lh0$a;

    if-eqz v0, :cond_0

    .line 2
    iget-object v1, p0, Lz;->k:Lh0;
    ...
    .line 3
    iput-object v0, p0, Lz;->k:Lh0;

    .line 4
    iput-object v0, p0, Lz;->l:Lh0$a;
