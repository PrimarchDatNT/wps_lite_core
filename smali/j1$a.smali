...
# virtual methods
.method public a(Lw1;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    .locals 3
    .param p1    # Lw1;
    ...
    .line 3
    invoke-virtual {p1, p2, v2}, Lw1;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj1$a;->l(Lw1;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
...
.method public b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 6
    invoke-virtual {p0, p1}, Lj1$a;->k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 8
    invoke-virtual {p0, p1}, Lj1$a;->j(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 10
    invoke-virtual {p0, p1}, Lj1$a;->g(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 12
    invoke-virtual {p0, p1}, Lj1$a;->i(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, v0, p2}, Lj1$a;->f([II)Z
    ...
    invoke-static {p1, p2}, La2;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public d(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    .line 4
    invoke-static {p1, v0}, La2;->c(Landroid/content/Context;I)I

    move-result v4

    .line 5
    invoke-static {}, Lj1;->a()Landroid/graphics/PorterDuff$Mode;

    move-result-object v5

    .line 6
    invoke-virtual {p0, p2, v4, v5}, Lj1$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 10
    invoke-virtual {p0, p2, v0, v3}, Lj1$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 12
    invoke-static {p1, p3}, La2;->c(Landroid/content/Context;I)I
    ...
    .line 14
    invoke-virtual {p0, p2, p1, p3}, Lj1$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 18
    invoke-static {p1, v0}, La2;->b(Landroid/content/Context;I)I
    ...
    .line 20
    invoke-virtual {p0, p2, v0, v4}, Lj1$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 24
    invoke-virtual {p0, p2, v3, v4}, Lj1$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
...
.method public e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {p0, v1, p2}, Lj1$a;->f([II)Z
    ...
    .line 11
    invoke-static {p3}, Ls1;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 13
    :cond_5
    invoke-static {p1, v2}, La2;->c(Landroid/content/Context;I)I

    move-result p1

    .line 14
    invoke-static {p1, v0}, Lj1;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public final g(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 1
    invoke-virtual {p0, p1, v0}, Lj1$a;->h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public final h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, La2;->b(Landroid/content/Context;I)I

    move-result p1

    .line 3
    sget-object v3, La2;->b:[I
    ...
    .line 5
    invoke-static {v2, p2}, Ld7;->b(II)I
...
.method public final k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, La2;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 10
    invoke-static {p1, v2}, La2;->b(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v3}, La2;->c(Landroid/content/Context;I)I
...
.method public final l(Lw1;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    .locals 4
    .param p1    # Lw1;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p1, p2, v0}, Lw1;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, p2, v1}, Lw1;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 1
    invoke-static {p1}, Ls1;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_1
    invoke-static {p2, p3}, Lj1;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
