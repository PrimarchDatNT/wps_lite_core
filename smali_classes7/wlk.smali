...
.source "WpsTextOutlinePaint.java"
...
# direct methods
.method public constructor <init>(FILllk;Z)V
    .locals 1
    ...
    .line 16
    iput-boolean p4, p0, Lwlk;->i:Z

    .line 17
    invoke-virtual {p0}, Lwlk;->i()F
...
.method public constructor <init>(Lllk;FFFF)V
    .locals 1
...
.method public final a(Landroid/text/TextPaint;)V
    ...
    invoke-direct {v1, v0, v2, v3}, Lolk;-><init>(FFF)V

    .line 4
    iget-object v0, p0, Lwlk;->a:Lllk;

    invoke-virtual {v0}, Lllk;->c()Lflk;

    move-result-object v0

    iget v2, p0, Lwlk;->d:F

    invoke-virtual {v1, p1, v0, v2}, Lolk;->a(Landroid/text/TextPaint;Lflk;F)V
    ...
    sget-object v1, Lllk$b;->I:Lllk$b;
...
.method public final c(Landroid/text/TextPaint;F)V
    ...
    .line 1
    invoke-virtual {p0, p2}, Lwlk;->h(F)Landroid/graphics/PathEffect;

    move-result-object v0

    .line 2
    iget-object v1, p0, Lwlk;->a:Lllk;

    invoke-virtual {v1}, Lllk;->b()I
    ...
    .line 3
    invoke-virtual {p0, v0, p2}, Lwlk;->g(Landroid/graphics/PathEffect;F)Landroid/graphics/PathEffect;
...
.method public final f(Landroid/text/TextPaint;)V
    ...
    .line 5
    invoke-virtual {p0, p1}, Lwlk;->a(Landroid/text/TextPaint;)V

    .line 6
    invoke-virtual {p0, p1}, Lwlk;->e(Landroid/text/TextPaint;)V

    .line 7
    invoke-virtual {p0, p1}, Lwlk;->d(Landroid/text/TextPaint;)V

    .line 8
    iget v0, p0, Lwlk;->e:F

    invoke-virtual {p0, p1, v0}, Lwlk;->c(Landroid/text/TextPaint;F)V
...
.method public final g(Landroid/graphics/PathEffect;F)Landroid/graphics/PathEffect;
    ...
    invoke-virtual {v0}, Lllk;->b()I

    move-result v0

    invoke-static {v0}, Lwlk;->j(I)[F
    ...
    .line 3
    invoke-static {v0, p2}, Lwlk;->k([FF)V
...
.method public l(Landroid/text/TextPaint;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Lwlk;->f(Landroid/text/TextPaint;)V
    ...
    .line 3
    invoke-virtual {p0, p1}, Lwlk;->b(Landroid/text/TextPaint;)V
