...
# interfaces
.implements Ljpl;
.implements Lcn/wps/moffice/writer/bottombar/BottomExpandPanel$b;
...
.method public constructor <init>(Landroid/view/ViewGroup;Lcn/wps/moffice/writer/Writer;)V
    ...
    invoke-direct {v0, p0}, Lkpl$a;-><init>(Lkpl;)V

    iput-object v0, p0, Lkpl;->a0:Lopl;

    .line 3
    new-instance v0, Lkpl$b;

    invoke-direct {v0, p0}, Lkpl$b;-><init>(Lkpl;)V

    iput-object v0, p0, Lkpl;->b0:Lqpl;

    .line 4
    iput-object p2, p0, Lkpl;->V:Lcn/wps/moffice/writer/Writer;

    .line 5
    iput-object p2, p0, Lkpl;->Y:Liqi;

    .line 6
    iput-object p1, p0, Lkpl;->Z:Landroid/view/ViewGroup;
    ...
    iget-object v1, p0, Lkpl;->a0:Lopl;

    invoke-direct {p1, p2, v0, v1}, Lspl;-><init>(Lcn/wps/moffice/common/beans/ActivityController;Lzri;Lopl;)V

    iput-object p1, p0, Lkpl;->X:Lspl;

    .line 8
    new-instance p1, Lvpl;

    iget-object v0, p0, Lkpl;->Z:Landroid/view/ViewGroup;

    iget-object v1, p0, Lkpl;->b0:Lqpl;

    invoke-direct {p1, v0, v1}, Lvpl;-><init>(Landroid/view/ViewGroup;Lqpl;)V

    iput-object p1, p0, Lkpl;->T:Lvpl;
    ...
    iput-object p1, p0, Lkpl;->U:Lfql;

    return-void
.end method

.method public static synthetic b1(Lkpl;)Lspl;
    .locals 0

    .line 1
    iget-object p0, p0, Lkpl;->X:Lspl;

    return-object p0
.end method

.method public static synthetic c1(Lkpl;)Lvpl;
    .locals 0

    .line 1
    iget-object p0, p0, Lkpl;->T:Lvpl;

    return-object p0
.end method

.method public static synthetic d1(Lkpl;)Lfql;
    .locals 0

    .line 1
    iget-object p0, p0, Lkpl;->U:Lfql;

    return-object p0
.end method

.method public static synthetic e1(Lkpl;Ljava/lang/CharSequence;)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1}, Lkpl;->n1(Ljava/lang/CharSequence;)V

    return-void
.end method

.method public static synthetic f1(Lkpl;)Lcn/wps/moffice/writer/Writer;
    .locals 0

    .line 1
    iget-object p0, p0, Lkpl;->V:Lcn/wps/moffice/writer/Writer;

    return-object p0
.end method

.method public static synthetic g1(Lkpl;)Liqi;
    .locals 0

    .line 1
    iget-object p0, p0, Lkpl;->Y:Liqi;

    return-object p0
.end method

.method public static synthetic h1(Lkpl;)Z
    .locals 0

    .line 1
    invoke-virtual {p0}, Lkpl;->l1()Z
...
.method public V0(Z)V
    ...
    .line 1
    invoke-virtual {p0}, Lkpl;->j1()Lkxh;

    move-result-object p1

    invoke-virtual {p0, p1}, Lkpl;->m1(Lkxh;)V

    goto :goto_0

    .line 2
    :cond_0
    invoke-virtual {p0}, Lkpl;->k1()V
...
.method public b0()V
    ...
    .line 1
    iget-object v0, p0, Lkpl;->T:Lvpl;

    invoke-virtual {v0}, Lvpl;->E2()Lppl;

    move-result-object v0

    .line 2
    iget-object v1, p0, Lkpl;->X:Lspl;
    ...
    iget-object v2, p0, Lkpl;->V:Lcn/wps/moffice/writer/Writer;
    ...
    .line 4
    invoke-virtual {p0, v0}, Lkpl;->i1(Lppl;)V
...
.method public dispose()V
    ...
    .line 1
    iput-object v0, p0, Lkpl;->V:Lcn/wps/moffice/writer/Writer;
    ...
    .line 3
    iput-object v0, p0, Lkpl;->X:Lspl;

    .line 4
    iput-object v0, p0, Lkpl;->Y:Liqi;

    .line 5
    iput-object v0, p0, Lkpl;->T:Lvpl;

    .line 6
    iput-object v0, p0, Lkpl;->U:Lfql;
...
.method public k1()V
    ...
    iget-boolean v1, p0, Lkpl;->W:Z

    const/4 v2, 0x1

    xor-int/2addr v1, v2

    invoke-virtual {v0, v1}, Lvpl;->H2(Z)V
    ...
    .line 11
    iget-object v0, p0, Lkpl;->V:Lcn/wps/moffice/writer/Writer;
...
.method public m1(Lkxh;)V
    ...
    invoke-virtual {v0, p1, v1}, Lvpl;->Z2(Lkxh;Z)V

    .line 3
    iget-object p1, p0, Lkpl;->X:Lspl;
    ...
    iput-boolean p1, p0, Lkpl;->W:Z

    .line 5
    iget-object p1, p0, Lkpl;->T:Lvpl;

    invoke-virtual {p1}, Lvpl;->B2()V
