...
.source "IWdPapxListExporterImpl.java"
...
.method public constructor <init>(Lrkj;)V
    ...
    .line 2
    iput-object p1, p0, Ltkj;->a:Lrkj;

    .line 3
    invoke-virtual {p0}, Ltkj;->b()V
...
.method public a(Lkkj$b;)V
    ...
    .line 9
    invoke-interface {v6}, Lxci;->p()Lghi;
    ...
    invoke-interface {p1, v8, v7, v0}, Lkkj$b;->c(ILyci$a;Lkkj$a;)V
    ...
    invoke-interface {v1}, Lxci;->last()Lxci$a;

    move-result-object v1

    .line 18
    iget-object v2, p0, Ltkj;->a:Lrkj;
