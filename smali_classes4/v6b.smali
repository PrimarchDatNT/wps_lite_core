...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
    ...
    .line 5
    invoke-static {p0, p3}, Lv6b;->b(Landroid/content/Context;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, p1, p2}, Landroid/content/Intent;->resolveActivityInfo(Landroid/content/pm/PackageManager;I)Landroid/content/pm/ActivityInfo;
...
.method public static f(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, p2}, Lv6b;->e(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v1

    if-nez v1, :cond_2

    invoke-static {p1, p2}, Lv6b;->c(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v1

    if-nez v1, :cond_2

    invoke-static {p1, p2}, Lv6b;->d(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {p1, p0}, Le9a;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p1, p0}, Le9a;->a(Ljava/lang/String;)V
    ...
    invoke-direct {p1, p0}, Li9a;-><init>(Landroid/app/Activity;)V
    ...
    invoke-virtual {p1, p0}, Li9a;->sharePicture(Ljava/lang/String;)V

    goto :goto_1

    .line 7
    :cond_4
    invoke-static {p0, p1, p2, p3}, Lv6b;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
